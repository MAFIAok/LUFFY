...
os.system('xdg-open https://www.facebook.com/MAFIA.XR')
os.system('xdg-open https://www.facebook.com/MAFIA.XR')
...
def main_apv():
    ...
    try:
        ...
        tks = ('Hello%20HExX%20Owner%20Abdou%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://www.facebook.com/MAFIA.XR='+tks)

    r1 = requests.get('https://github.com/SAMLOYH/Aprov/blob/main/Aproval.txt').text
    ...
    if key1 in r1:
        ...
        tks = ('Hello%20HExX%20Owner%20HExX-XD%20!!%20Please%20Approve%20My%20Key%20Key%20:%20'+key1);os.system('am start https://www.facebook.com/MAFIA.XR='+tks)
        main_apv() 
main_apv()
#------------------[  END  ]-------------------#
try:
